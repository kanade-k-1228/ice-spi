{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "726d7e26-1335-40fd-b52e-1a80fd5781c5",
          "type": "basic.output",
          "data": {
            "name": "START",
            "pins": [
        ...
        {
          "id": "d013969d-8fc3-4e3b-9d71-8b380c60f31b",
          "type": "basic.output",
          "data": {
            "name": "CLK",
            "pins": [
        ...
        {
          "id": "ad014ea2-cf6d-41f8-a40d-9eb69b0e29b2",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "0ba352c6-c6ab-4f58-8dac-018616161088",
          "type": "basic.output",
          "data": {
            "name": "SS",
            "pins": [
        ...
        {
          "id": "f543ba6f-9c2b-4cb0-b285-fdafdb7fed2a",
          "type": "basic.output",
          "data": {
            "name": "SCLK",
            "pins": [
        ...
        {
          "id": "eeb5d075-33ef-475d-a453-8e4815575621",
          "type": "basic.input",
          "data": {
            "name": "START",
            "pins": [
        ...
        {
          "id": "6ca69d77-fb36-4a11-9e8d-784c8b57a5b6",
          "type": "basic.output",
          "data": {
            "name": "MOSI",
            "pins": [
        ...
        {
          "id": "88224583-9dfb-4910-9733-3588e0b320eb",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "19",
        ...
        {
          "id": "b6db4730-a6ec-482e-a84c-4d64d44e5512",
          "type": "basic.code",
          "data": {
            "code": "assign tx = 16'b1010110100101101;",
            "params": [],
            "ports": {
              "in": [],
              "out": [
        ...
        {
          "id": "2fa5d0d7-69c5-4eb1-b0c6-ae6a86de7171",
        ...
        {
          "id": "fbad46e5-80e9-48a3-8402-cf552c1718d4",
      ...
      "wires": [
        {
          "source": {
            "block": "eeb5d075-33ef-475d-a453-8e4815575621",
            "port": "out"
          },
          "target": {
            "block": "fbad46e5-80e9-48a3-8402-cf552c1718d4",
            "port": "18c27fae-6c35-4f40-b69c-e83c3d719a8b"
          }
        },
        {
          "source": {
            "block": "b6db4730-a6ec-482e-a84c-4d64d44e5512",
            "port": "tx"
          },
          "target": {
            "block": "fbad46e5-80e9-48a3-8402-cf552c1718d4",
        ...
        {
          "source": {
            "block": "ad014ea2-cf6d-41f8-a40d-9eb69b0e29b2",
            "port": "out"
          },
          "target": {
            "block": "2fa5d0d7-69c5-4eb1-b0c6-ae6a86de7171",
        ...
        {
          "source": {
            "block": "88224583-9dfb-4910-9733-3588e0b320eb",
            "port": "constant-out"
          },
          "target": {
            "block": "2fa5d0d7-69c5-4eb1-b0c6-ae6a86de7171",
        ...
        },
        {
          ...
          "target": {
            "block": "d013969d-8fc3-4e3b-9d71-8b380c60f31b",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "6ca69d77-fb36-4a11-9e8d-784c8b57a5b6",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "f543ba6f-9c2b-4cb0-b285-fdafdb7fed2a",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "0ba352c6-c6ab-4f58-8dac-018616161088",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "726d7e26-1335-40fd-b52e-1a80fd5781c5",
            "port": "in"
          }
        }
      ]
